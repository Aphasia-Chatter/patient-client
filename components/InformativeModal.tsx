...
const InformativeModal: React.FC<InformativeModalProps> = ({ headerMessage, informativeMessage, modalVisible, setModalVisible }) => {
    // Modal Header
    const modalHeader=(
        <View className='bg-gray-500' style={styles.modalHeader}>
